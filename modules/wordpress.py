...
""").split("\n")
    ...
    try:
        ...
        url = input(Fore.RED+" ┌─["+Fore.LIGHTGREEN_EX+"WEBGET"+Fore.BLUE+"~"+Fore.WHITE+"@HOME"+Fore.RED+"/"+Fore.CYAN+"CMN"+Fore.RED+"/"+Fore.LIGHTYELLOW_EX+"WP"+Fore.RED+"/"+Fore.GREEN+"Get-Plugins"+Fore.RED+"""]
 └──╼ 卐 """).lower()
        if url == "" or None:
...
def user():
    try:
        print(Fore.GREEN+" [+] Please Enter WordPress URL\n")
        print(Fore.RED+" [!] Please Do Not Include Http\n")
        Url = input(Fore.RED+" ┌─["+Fore.LIGHTGREEN_EX+"WEBGET"+Fore.BLUE+"~"+Fore.WHITE+"@HOME"+Fore.RED+"/"+Fore.CYAN+"CMN"+Fore.RED+"/"+Fore.LIGHTYELLOW_EX+"WP"+Fore.RED+"/"+Fore.GREEN+"Get-Username"+Fore.RED+"""]
 └──╼ """+Fore.WHITE+"卐 ").lower()
